...
public class HealthBarRenderer {
    ...
    public void onRenderWorldLast(RenderWorldLastEvent event) {
        ...
        if (NeatConfig.renderInF1 || Minecraft.isGuiEnabled()) {
            ...
            for (Entity entity : (Set<Entity>) ReflectionHelper.getPrivateValue(WorldClient.class, client, new String[] {"entityList", "field_73032_d", "J"})) {
                if (entity != null
                ...
                if (!(distance > (float) NeatConfig.maxDistance)
                    ...
                    if (!(maxHealth <= 0.0F)) {
                        ...
                        if (entity instanceof EntityCustomNpc) {
                            ...
                            if (!((EntityCustomNpc) entity).display.title.equals("")) {
                                name += " – " + title;
                            }
                        ...
                        if (NeatConfig.drawBackground) {
                            ...
                            tessellator.addVertex((double) (-size - padding), (double) ((float) barHeight + padding), 0.0);
                            tessellator.addVertex((double) (size + padding), (double) ((float) barHeight + padding), 0.0);
                            tessellator.addVertex((double) (size + padding), (double) (-bgHeight), 0.0);
                            tessellator.draw();
                        }
